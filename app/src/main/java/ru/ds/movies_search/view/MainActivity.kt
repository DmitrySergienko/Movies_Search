...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        bind.ok.setOnClickListener(clickListener)
    ...
    private var clickListener: View.OnClickListener = object : View.OnClickListener {
        ...
        override fun onClick(v: View?) {
            try {
                val uri = URL(bind.url.text.toString())
                ...
                Thread {
                    ...
                    try {
                        ...
                        handler.post {
                            bind.webview.loadDataWithBaseURL(null, result, "text/html; charset=utf-8", "utf-8", null)
                        }
                    } catch (e: Exception) {
